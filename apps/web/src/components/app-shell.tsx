...
import { Menu, LogOut, ScanLine, FolderKanban, Shield, ChevronDown, KeyRound, PackageSearch } from "lucide-react";
...
const navItems = [
  ...
  { href: "/app/dependencies", label: "Dependencies", icon: PackageSearch },
